...
const CustomErrorMessage = ({ showMessageAlert, setShowMessageAlert, title, message }: { showMessageAlert: boolean, setShowMessageAlert: (args: boolean) => void, title: string, message: string }) => {
    return (
        <AwesomeAlert
            ...
            customView={
                <View style={{ backgroundColor: 'red', padding: 10, marginVertical: 8, borderRadius: 10, width: '100%' }}>
